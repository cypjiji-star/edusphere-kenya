...
const GenerateTeamIconInputSchema = z.object({
  description: z
    .string()
    .describe("A description of a sports team or school club."),
});
...
const GenerateTeamIconOutputSchema = z.object({
  icon: z
    .string()
    .describe("A single emoji that best represents the team description."),
});
export type GenerateTeamIconOutput = z.infer<
  typeof GenerateTeamIconOutputSchema
>;
