...
const PersonalizedLearningPathInputSchema = z.object({
  ...
  subject: z.string().describe('The subject for which to generate the learning path.'),
  gradeLevel: z.string().describe('The grade level of the student.'),
  learningStandard: z.string().describe('The specific learning standard to achieve.'),
  currentUnderstanding: z.string().describe('Description of the student\'s current understanding of the subject.'),
});
...
const PersonalizedLearningPathOutputSchema = z.object({
  learningPath: z.string().describe('A detailed, personalized learning path for the student.'),
});
