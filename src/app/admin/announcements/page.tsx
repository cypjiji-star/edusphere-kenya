...
const announcementCategories: Record<
...
const announcementSchema = z.object({
  ...
  category: z.nativeEnum(
    Object.keys(announcementCategories) as [AnnouncementCategory],
  ),
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Stats for the announcement sent on{" "}
            {announcement.sentAt.toDate().toLocaleString()}.
          </DialogDescription>
        </DialogHeader>
...
export default function AdminAnnouncementsPage() {
  ...
  const [selectedAnnouncementForStats, setSelectedAnnouncementForStats] =
  ...
  React.useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      const fetchedAnnouncements = snapshot.docs.map(
  ...
  const paginatedAnnouncements = React.useMemo(() => {
    ...
    return pastAnnouncements.slice(
      startIndex,
    ...
    try {
      if (attachedFile) {
        const storageRef = ref(
          storage,
          `schools/${schoolId}/announcements/${Date.now()}_${attachedFile.name}`,
        );
      ...
      <main className="p-4 md:p-6 lg:p-8">
        <div className="mb-6 p-4 md:p-6 bg-card border rounded-lg">
          ...
          <p className="text-muted-foreground">
            Broadcast messages to the entire school community.
          </p>
        </div>
          ...
          <TabsContent value="all">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  A live feed of all announcements sent by admins and teachers.
                </CardDescription>
              </CardHeader>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <Badge
                            className={cn(
                              announcementCategories[ann.category]?.color,
                            )}
                          >
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent>
                              ...
                              <DropdownMenuItem
                                ...
                                onSelect={() => setAnnouncementToDelete(ann.id)}
                              >
                        ...
                        <div className="flex items-center gap-2" title="Views">
                          ...
                          <span className="font-medium">
                            {ann.totalRecipients > 0
                              ? Math.round(
                                  (ann.readCount / ann.totalRecipients) * 100,
                                )
                              : 0}
                            % view rate
                          </span>
              ...
              <CardFooter>
                <div className="text-xs text-muted-foreground">
                  Showing <strong>{paginatedAnnouncements.length}</strong> of{" "}
                  <strong>{pastAnnouncements.length}</strong> announcements.
                </div>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)}>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Draft and send a new broadcast message to selected groups.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="e.g., School Closure for Public Holiday"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Use the AI to translate your message into multiple
                        ...
                        >
                          <div className="flex flex-col items-center justify-center pt-5 pb-6 text-center">
                            ...
                            <p className="mb-2 text-sm text-muted-foreground">
                              Attach files, images, or newsletters
                            </p>
                            <p className="text-xs text-muted-foreground">
                              (PDF, JPG, etc.)
                            </p>
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            >
                              ...
                              <SelectContent>
                                <SelectItem value="All Students, Parents & Staff">
                                ...
                                <SelectItem value="specific-classes">
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            >
                              ...
                              <SelectContent>
                                {Object.entries(announcementCategories).map(
                                  ([key, { label }]) => (
                                    <SelectItem
                                      key={key}
                                      value={key as AnnouncementCategory}
                                    >
                                      {label}
                                    </SelectItem>
                                  ),
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            ...
                            >
                              ...
                              {scheduledDate ? (
                                format(scheduledDate, "PPP 'at' h:mm a")
                              ) : (
                    ...
                    <div className="space-y-4">
                      <Alert>
                        ...
                        <AlertDescription>
                          ...
                          Additional charges may apply for SMS.
                        </AlertDescription>
                      </Alert>
