                ...
                <div className="grid gap-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Notify relevant groups about this event.
                    </p>
                    ...
                    {eventsForDay.map((event) => (
                      <DialogTrigger asChild key={event.id}>
                        <Badge
                          ...
                          className={cn(
                            "w-full truncate text-white text-[10px] md:text-xs cursor-pointer",
                    ...
                    return (
                      <DialogTrigger key={event.id} asChild>
                        <div
                          onClick={() => setSelectedEvent(event)}
                          className={cn(
                            "absolute w-[calc(100%-4px)] ml-[2px] p-2 rounded-lg text-white text-xs cursor-pointer",
                            eventColors[event.type],
                          )}
      ...
      {selectedEvent && (
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            ...
            <DialogDescription>
              <Badge
                className={cn("text-white", eventColors[selectedEvent.type])}
              >
                {selectedEvent.type}
              </Badge>
            </DialogDescription>
