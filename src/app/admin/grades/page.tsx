...
export default function AdminGradesPage() {
  ...
  // Fetch and compute rankings for all classes for the selected exam
  React.useEffect(() => {
    ...
    const fetchAllRankings = async () => {
      ...
      for (const c of allClasses) {
        ...
        studentsByClass[c.id] = studentSnap.docs.map((d) => ({
          id: d.id,
          name: d.data().name,
          avatarUrl:
            d.data().avatarUrl || `https://picsum.photos/seed/${d.id}/100`,
          grades: {},
        }));
      }
  ...
  const handleExamStatusChange = async (
    examId: string,
    status: "Open" | "Closed",
  ) => {
    if (!schoolId) return;
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Review student performance and manage examination periods.
        </p>
      </div>
            ...
            <CardContent>
              {isLoading.rankings ? (
                ...
                <div className="text-center py-16 text-muted-foreground">
                  Please select an active exam to view class rankings.
                </div>
              ) : (
                        ...
                        <AccordionContent>
                          {rankedStudents.length > 0 ? (
                            ...
                            <div className="text-center text-muted-foreground py-8">
                              No grades submitted for this class for the
                              selected exam.
                            </div>
                          )}
                        </AccordionContent>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Define a new examination period for the school.
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  A log of all open examination periods.
                </CardDescription>
              </CardHeader>
              <CardContent>
                {isLoading.exams ? (
                        ...
                        <TableRow key={exam.id}>
                          ...
                          <TableCell className="text-right space-x-1">
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                handleExamStatusChange(exam.id, "Closed")
                              }
                            >
        ...
        <TabsContent value="archives" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                A historical record of all closed examination periods.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {isLoading.exams ? (
                      ...
                      <TableRow key={exam.id}>
                        ...
                        <TableCell>
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              handleExamStatusChange(exam.id, "Open")
                            }
                          >
