...
export default function SettingsPage() {
  ...
  const [reminderMessage, setReminderMessage] = React.useState(
    "Dear Parent, this is a friendly reminder that a fee balance of {balance} for {studentName} is overdue. Please make a payment at your earliest convenience.",
  );
  ...
  const handleSaveSettings = async () => {
    ...
    toast({
      ...
      description:
        "Your changes to the automated communication have been saved.",
    });
  };
  ...
  const handleCreateBackup = () => {
    toast({
      ...
      description:
        "A manual backup of your data is being created. You will be notified upon completion.",
    });
  };
  ...
  const handleRestoreBackup = () => {
    toast({
      ...
      description:
        "Restoring from a backup is a critical action. Please contact support to proceed.",
      variant: "destructive",
    });
  };
  ...
  const handleArchive = () => {
    toast({
      ...
      description:
        "Older records are being archived based on your retention policy.",
    });
  };
  ...
  const handleRollback = () => {
    toast({
      ...
      description:
        "In a real application, this would revert the last profile change.",
    });
  };
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Manage global settings for the school portal.
        </p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Global configuration for your school portal.
              </CardDescription>
            </CardHeader>
                ...
                <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      This is managed in the School Profile section.
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) => {
                        setTimezone(v);
                        handleSettingChange("general", "timezone", v);
                      }}
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) => {
                        setLanguage(v);
                        handleSettingChange("general", "language", v);
                      }}
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) => {
                        setAcademicYear(v);
                        handleSettingChange("general", "academicYear", v);
                      }}
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) => {
                        setCurrentTerm(v);
                        handleSettingChange("general", "currentTerm", v);
                      }}
                    >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage password policies, registration, and other security
                settings.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                <div>
                  <Label htmlFor="password-policy" className="font-semibold">
                    Password Policy
                  </Label>
                  <p className="text-xs text-muted-foreground">
                    Set minimum length and complexity for user passwords.
                  </p>
                </div>
                <Dialog>
              ...
              <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                <div>
                  <Label htmlFor="idle-timeout" className="font-semibold">
                ...
                <Select
                  ...
                  onValueChange={(v) => {
                    setIdleTimeout(v);
                    handleSettingChange("security", "idleTimeout", v);
                  }}
                >
              ...
              <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                <div>
                  <Label htmlFor="self-registration" className="font-semibold">
                    Enable Self-Registration
                  </Label>
                  <p className="text-xs text-muted-foreground">
                    Allow new parents and students to create their own accounts.
                  </p>
                </div>
                <Switch
                  ...
                  onCheckedChange={(c) => {
                    setSelfRegistration(c);
                    handleSettingChange("security", "selfRegistration", c);
                  }}
                />
              </div>
              <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Require a second verification step for admins and teachers.
                  </p>
                </div>
                <Switch
                  id="2fa"
                  ...
                  onCheckedChange={(c) => {
                    setTwoFactorAuth(c);
                    handleSettingChange("security", "twoFactorAuth", c);
                  }}
                />
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage automated notifications for key system events.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4 p-3 rounded-lg border">
                <div className="flex items-center justify-between space-x-2">
                  <div>
                    <Label htmlFor="fee-alerts" className="font-semibold">
                      Automated Fee Reminders
                    </Label>
                    <p className="text-xs text-muted-foreground">
                      Automatically notify parents about outstanding fee
                      balances.
                    </p>
                  </div>
                  <Switch
                    id="fee-alerts"
                    checked={feeAlertsEnabled}
                    onCheckedChange={(c) => {
                      setFeeAlertsEnabled(c);
                      handleSettingChange(
                        "notifications",
                        "feeAlertsEnabled",
                        c,
                ...
                <div className={!feeAlertsEnabled ? "opacity-50" : ""}>
                  ...
                  <div className="space-y-4 pl-2 pt-4">
                    <div className="grid w-full max-w-sm items-center gap-1.5">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Select
                          ...
                          disabled={
                            !feeAlertsEnabled || reminderSchedule !== "weekly"
                          }
                        >
                          <SelectTrigger className="w-[120px]">
                            <SelectValue />
                    ...
                    <div className="grid w-full max-w-xs items-center gap-1.5">
                      ...
                      <div className="flex items-center gap-2">
                        <Input
                          ...
                          onChange={(e) => {
                            setReminderThreshold(Number(e.target.value));
                            handleSettingChange(
                              "notifications",
                              "reminderThreshold",
                    ...
                    <div className="grid w-full items-center gap-1.5">
                      ...
                      <Textarea
                        id="reminder-message"
                        placeholder="Customize the message sent to parents."
              ...
              <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                <div>
                  <Label htmlFor="attendance-alerts" className="font-semibold">
                    Low Attendance Alerts
                  </Label>
                  <p className="text-xs text-muted-foreground">
                    Notify administration when a class has low attendance.
                  </p>
                </div>
                <Switch
                  ...
                  onCheckedChange={(c) => {
                    setAttendanceAlerts(c);
                    handleSettingChange("notifications", "attendanceAlerts", c);
                  }}
                />
              </div>
              <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                <div>
                  <Label htmlFor="system-alerts" className="font-semibold">
                    Critical System Notifications
                  </Label>
                  <p className="text-xs text-muted-foreground">
                    Alerts for storage limits, failed payments, etc.
                  </p>
                </div>
                <Switch
                  id="system-alerts"
                  ...
                  onCheckedChange={(c) => {
                    setSystemAlerts(c);
                    handleSettingChange("notifications", "systemAlerts", c);
                  }}
                />
              </div>
              <Separator />
              <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Configure SMS, Email, and Payment gateways.
                  </p>
                </div>
                <Dialog>
                  <DialogTrigger asChild>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle>
                        Communication & Payment Gateways
                      </DialogTitle>
                      <DialogDescription>
                        Manage gateways for sending SMS, email, and processing
                        payments.
                      </DialogDescription>
                    </DialogHeader>
                    <div className="py-4 space-y-4">
                    ...
                    <DialogFooter>
                      ...
                      <DialogClose asChild>
                        <Button
                          onClick={() => toast({ title: "Gateways Saved" })}
                        >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage AI-powered features and integrations.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                <div>
                  <Label htmlFor="ai-chatbot" className="font-semibold">
                    Enable AI Support Chatbot
                  </Label>
                  <p className="text-xs text-muted-foreground">
                    Provide instant assistance to users via an AI-powered
                    chatbot.
                  </p>
                </div>
                <Switch
                  ...
                  onCheckedChange={(c) => {
                    setAiChatbot(c);
                    handleSettingChange("ai", "aiChatbot", c);
                  }}
                />
              </div>
            </CardContent>
        ...
        <div className="lg:col-span-1 space-y-8">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <Separator />
              <div className="space-y-2">
                <Label htmlFor="retention-policy" className="font-semibold">
                ...
                <Select
                  ...
                  onValueChange={(v) => {
                    setDataRetention(v);
                    handleSettingChange("data", "dataRetention", v);
                  }}
                >
                ...
                <p className="text-xs text-muted-foreground">
                  Set how long logs and attendance data are kept.
                </p>
              </div>
              <Separator />
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                  ...
                  <Select
                    ...
                    onValueChange={(v) => {
                      setAutoBackup(v);
                      handleSettingChange("data", "autoBackup", v);
                    }}
                  >
            ...
            <CardFooter>
              <p className="text-xs text-muted-foreground">
                Manage data policies and backups.
              </p>
            </CardFooter>
          </Card>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                A log of recent changes made to system settings.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Temporarily disable access for non-administrators.
                  </p>
                </div>
                <Switch
                  id="maintenance-mode"
                  ...
                  onCheckedChange={(c) => {
                    ...
                    handleSettingChange("maintenance", "maintenanceMode", c);
                  }}
                />
              </div>
            </CardContent>
