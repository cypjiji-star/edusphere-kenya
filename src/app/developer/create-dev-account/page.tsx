    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="w-full max-w-md">
         <div className="text-center mb-6">
            ...
            <h1 className="text-3xl font-bold font-headline text-primary">Developer Registration</h1>
            <p className="text-muted-foreground">Create your super admin account</p>
        </div>
        <Card>
