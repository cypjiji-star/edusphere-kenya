...
export default function DeveloperSettingsPage() {
  ...
  const [passwordRequireUppercase, setPasswordRequireUppercase] =
    React.useState(true);
  const [passwordRequireNumber, setPasswordRequireNumber] =
    React.useState(true);
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Manage global settings, integrations, and policies for all schools on
          the platform.
        </p>
      </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Global Communication Gateways
              </CardTitle>
              <CardDescription>
                Configure gateways for sending SMS and email notifications
                across the platform.
              </CardDescription>
            </CardHeader>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) => {
                        setSmsProvider(v);
                        handleSettingChange("communication", "smsProvider", v);
                      }}
                    >
                      <SelectTrigger>
                        <SelectValue />
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Set minimum length and complexity for all user passwords.
                  </p>
                </div>
                <Dialog>
                  ...
                  <DialogContent>
                    ...
                    <div className="py-4 space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setPasswordMinLength(Number(e.target.value))
                          }
                          className="w-24"
                        />
                      </div>
                    ...
                    <DialogFooter>
                      ...
                      <DialogClose asChild>
                        <Button onClick={handlePasswordPolicySave}>
                          Save Policy
                        </Button>
                      </DialogClose>
                    </DialogFooter>
              ...
              <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Require 2FA for all admin and teacher roles across all
                    schools.
                  </p>
                </div>
                <Switch
                  ...
                  onCheckedChange={(v) => {
                    setTwoFactorAuth(v);
                    handleSettingChange("security", "twoFactorAuth", v);
                  }}
                />
              </div>
              <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                <div>
                  <Label htmlFor="audit-trail" className="font-semibold">
                    Global Audit Trail
                  </Label>
                  <p className="text-xs text-muted-foreground">
                    Ensure audit trails are enabled for all tenants.
                  </p>
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Set default for how long logs and financial data are kept.
                </p>
              </div>
              <Separator />
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Schedule daily or weekly backups for all instances.
                    </p>
                  </div>
                  <Select
                    value={autoBackup}
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between space-x-2 p-3 rounded-lg border">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Temporarily disable access for all non-admins.
                    </p>
                  </div>
                  <Switch
                    id="maintenance-mode"
