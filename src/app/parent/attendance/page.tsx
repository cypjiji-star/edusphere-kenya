  ...
  React.useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (error) => {
        ...
        toast({
          title: "Error",
          description: "Could not fetch your children's data.",
          variant: "destructive",
        });
        setIsLoading(false);
      },
    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6">
      <div className="mb-2 p-4 md:p-6 bg-card border rounded-lg">
        ...
        <p className="text-muted-foreground">
          View attendance data for your child.
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <Card>
          <CardContent className="p-8 text-center text-muted-foreground">
            No students linked to your parent account.
          </CardContent>
        </Card>
      ) : (
        <Tabs defaultValue="overview">
          ...
          <TabsContent value="overview" className="mt-4">
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button
                          ...
                          variant="outline"
                          className={cn(
                            "w-full justify-start text-left font-normal md:w-auto lg:min-w-[250px]",
                    ...
                    <Dialog>
                      ...
                      <DialogContent>
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Notify the school about your child's absence. This
                            will be sent to the school office and class teacher.
                          </DialogDescription>
                        </DialogHeader>
            ...
            {wasAbsentRecently && (
              <Alert variant="destructive" className="mt-6">
                ...
                <AlertDescription>
                  {childrenData.find((c) => c.id === selectedChild)?.name} was
                  marked absent recently. Please contact the school office if
                  this was unexpected.
                </AlertDescription>
              </Alert>
            )}
          ...
          <TabsContent value="history" className="mt-4">
            <Card>
              <CardHeader>
                <CardTitle>
                  Full Term History for{" "}
                  {childrenData.find((c) => c.id === selectedChild)?.name}
                </CardTitle>
                <CardDescription>
                  A complete log of attendance for the current term.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="w-full overflow-auto rounded-lg border">
