  ...
  const filteredEvents = React.useMemo(() => {
    ...
    return events.filter((event) => {
      ...
      const matchesAudience =
        !event.audience ||
        event.audience === "All" ||
        event.audience === currentChild?.classId;
        ...
        <div className="grid grid-cols-7">
          {weeks.map((weekStart) =>
            eachDayOfInterval({
              ...
              const eventsForDay = filteredEvents.filter((e) =>
        ...
        <DialogContent className="sm:max-w-xl">
                        ...
                        <Button
                          ...
                          onClick={() =>
                            handleToastAction(
                              ...
                              `Your download for "${file.name}" will start shortly.`,
                            )
                          }
                        >
          ...
          <DialogFooter className="gap-2 sm:gap-0">
            <Button
              variant="secondary"
              onClick={() =>
                handleToastAction("RSVP Sent", "Your response has been noted.")
              }
            >
            ...
            <Button
              ...
              onClick={() =>
                handleToastAction(
                  "Event Added",
                  "This event has been added to your personal calendar.",
                )
              }
            >
