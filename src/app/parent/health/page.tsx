...
export default function ParentHealthPage() {
  ...
  const [selectedChild, setSelectedChild] = React.useState<
    string | undefined
  >();
  const [healthRecord, setHealthRecord] = React.useState<HealthRecord | null>(
    null,
  );
  ...
  React.useEffect(() => {
    ...
    const unsubMeds = onSnapshot(medsQuery, (snapshot) => {
      setMedications(
        snapshot.docs.map((d) => ({ id: d.id, ...d.data() }) as Medication),
      );
    });
  ...
  const handleReportAbsence = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "The school administration has been notified of your child's absence.",
      });
      setAbsenceReason("");
    } catch (error) {
      ...
      toast({
        ...
        description: "Could not report absence. Please try again.",
        variant: "destructive",
      });
    }
  };
  ...
  const handleDownloadReport = () => {
    toast({
      ...
      description:
        "A comprehensive health report for your child is being generated.",
    });
  };
  ...
  const getUrgencyBadge = (
    ...
    switch (urgency) {
      case "Critical":
        return (
          <Badge className={cn(baseClasses, "bg-red-700 hover:bg-red-800")}>
            Critical
          </Badge>
        );
      case "High":
      ...
      case "Medium":
        return (
          <Badge
            className={cn(baseClasses, "bg-yellow-500 hover:bg-yellow-600")}
          >
            Medium
          </Badge>
        );
      case "Low":
        return (
          <Badge className={cn(baseClasses, "bg-blue-500 hover:bg-blue-600")}>
            Low
          </Badge>
        );
      default:
      ...
      <div className="p-4 sm:p-6 lg:p-8 space-y-6">
        <div className="mb-2 p-4 md:p-6 bg-card border rounded-lg">
          ...
          <p className="text-muted-foreground">
            View health records and incident reports for your child.
          </p>
        </div>
                ...
                <Dialog>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Notify the school about your child's absence. This will
                        be sent to the school office and class teacher.
                      </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          id="absence-reason"
                          placeholder="e.g., Doctor's appointment, feeling unwell..."
                          value={absenceReason}
                    ...
                    <DialogFooter>
                      ...
                      <DialogClose asChild>
                        <Button onClick={handleReportAbsence}>
                          Send Notification
                        </Button>
                      </DialogClose>
                    </DialogFooter>
        ...
        {hasNewIncident && (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              A new incident has been logged for{" "}
              {childrenData.find((c) => c.id === selectedChild)?.name}. Please
              review the details in the Incident Log below.
            </AlertDescription>
          </Alert>
        )}
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground flex items-center gap-1">
                  <Lock className="h-3 w-3" /> Medical records are confidential.
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent className="text-sm">
                <p>
                  <span className="font-medium">
                    {healthRecord?.emergencyContact.name}
                  </span>{" "}
                  ({healthRecord?.emergencyContact.relationship})
                </p>
                <p className="text-muted-foreground">
                  {healthRecord?.emergencyContact.phone}
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent className="text-sm">
                {healthRecord?.lastHealthCheck &&
                healthRecord.lastHealthCheck !== "N/A" ? (
                  <p className="font-semibold">
                    {format(new Date(healthRecord.lastHealthCheck), "PPP")}
                  </p>
                ) : (
          ...
          <div className="lg:col-span-2 space-y-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Records of any health or safety incidents at school.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  A log of medications administered at school.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Alert variant="default">
                  ...
                  <AlertDescription>
                    This log only shows medications administered with prior
                    parental consent. For a full medical history, please consult
                    the school nurse.
                  </AlertDescription>
                </Alert>
                    ...
                    <TableBody>
                      {medications.length > 0 ? (
                        medications.map((med) => (
                          <TableRow key={med.id}>
                            <TableCell className="font-medium">
                              {med.date.toDate().toLocaleString()}
                            </TableCell>
                        ...
                        <TableRow>
                          <TableCell colSpan={4} className="h-24 text-center">
                            No medications administered at school.
                          </TableCell>
                        </TableRow>
                      )}
                    </TableBody>
        ...
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            <div className="flex justify-between items-start">
              ...
              {selectedIncident.urgency &&
                getUrgencyBadge(selectedIncident.urgency)}
            </div>
            <DialogDescription>
              A detailed summary of the incident reported on{" "}
          ...
          <div className="py-4 space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {selectedIncident.actionsTaken || "No actions logged."}
              </p>
            </div>
