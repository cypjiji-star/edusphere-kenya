                            ...
                            {period.isBreak ? (
                              ...
                              <Popover>
                                <PopoverTrigger asChild>
                                  <div
                                    className={`p-2 rounded-md cursor-pointer transition-transform hover:scale-105 ${subjectDetails[subject as keyof typeof subjectDetails]?.color || "bg-gray-100 text-gray-800"}`}
                                  >
                                  ...
                                  <div className="space-y-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                      <Avatar className="h-9 w-9">
                                        <AvatarImage
                                          src={`https://picsum.photos/seed/${entry.subject.teacher}/100`}
                                          alt={entry.subject.teacher}
                                        />
                                        <AvatarFallback>
                                          {entry.subject.teacher.charAt(0)}
                                        </AvatarFallback>
                                      </Avatar>
                                      <div>
