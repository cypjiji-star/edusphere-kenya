    ...
    <Card>
      <CardHeader className="flex flex-row items-start justify-between gap-4">
        <div className="flex-1">
          ...
          <CardDescription>
            Posted: {announcement.sentAt?.toDate().toLocaleString()}
          </CardDescription>
        </div>
        <Badge
          className={cn(
            ...
            announcementCategories[
              announcement.category as AnnouncementCategory
            ]?.color,
          )}
        >
          {
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          <Avatar className="h-8 w-8">
            ...
            />
            <AvatarFallback>
              {announcement.sender.name.charAt(0)}
            </AvatarFallback>
          </Avatar>
          <div>
            <p className="text-xs font-semibold">
              Sent by {announcement.sender.name}
            </p>
          </div>
        </div>
      </CardContent>
...
export default function AnnouncementsPage() {
  ...
  const handleLoadMore = async () => {
    ...
    const newAnnouncements = documentSnapshots.docs.map(
      (doc) => ({ id: doc.id, ...doc.data() }) as Announcement,
    );
  ...
  async function onSubmit(values: AnnouncementFormValues) {
    if (!schoolId || !user) {
      toast({
        title: "Error",
        description: "Authentication or School ID is missing.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      const newAnnouncement = {
        ...
        sender: {
          ...
          name: teacherName,
          avatarUrl:
            user.photoURL || `https://picsum.photos/seed/${user.uid}/100`,
        },
  ...
  if (!schoolId)
    return <main className="p-8">Error: School ID missing from URL.</main>;
        ...
        <TabsContent value="all" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                A feed of all announcements from teachers and administrators.
              </CardDescription>
            </CardHeader>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Draft and send a new broadcast message.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="e.g., Reminder about upcoming CAT"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          >
                            ...
                            <SelectContent>
                              <SelectItem value="All My Students">
                                All My Students
                              </SelectItem>
