...
export function ResourceDetailsDialog({
  ...
  const [isRecommended, setIsRecommended] = React.useState(
      ...
      <DialogContent className="sm:max-w-xl">
        ...
        <div className="space-y-6 py-4">
          ...
          <div>
            ...
            <Badge
              variant={
                resource.status === "Available" || resource.status === "Digital"
                  ? "default"
                  : "destructive"
              }
            >
