...
export default function TeacherDashboard() {
  ...
  React.useEffect(() => {
    ...
    try {
      ...
      unsubscribers.push(
        onSnapshot(teacherDocRef, (docSnap) => {
          if (docSnap.exists()) {
          ...
          const unsubStudents = onSnapshot(
            ...
            async (studentsSnapshot) => {
              ...
              if (studentCount > 0) {
                ...
                const presentCount = attendanceSnapshot.docs.filter((r) =>
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <Card className="mb-8 overflow-hidden">
        <CardHeader className="bg-card border-b p-4 md:p-6">
          ...
          {clientReady && (
            <CardDescription>
              Your dashboard for {schoolName}. Today is{" "}
      ...
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          <TimetableWidget />
          {user && (
            <DashboardCharts teacherId={user.uid} teacherName={teacherName} />
          )}
        </div>
