...
export default function TeacherPaymentsPage() {
  ...
  React.useEffect(() => {
    ...
    const paymentsQuery = query(
      collection(firestore, `schools/${schoolId}/mini_payments`),
      where("teacherId", "==", teacherId),
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        const paymentsData = snapshot.docs.map(
          (doc) => ({ id: doc.id, ...doc.data() }) as MiniPayment,
        );
  ...
  const handleSavePayment = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Could not record payment. Please try again later.",
        variant: "destructive",
      });
    } finally {
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Record and track miscellaneous payments for your classes.
        </p>
      </div>
        ...
        <div className="lg:col-span-1">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Log a new payment received from a student.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="payment-desc"
                  placeholder="e.g., Class party contribution, Trip fee"
                  value={description}
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                A log of all mini-payments you have recorded.
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    {isLoading ? (
                      ...
                      payments.map((payment) => (
                        <TableRow key={payment.id}>
                          <TableCell>
                            {payment.recordedAt?.toDate().toLocaleDateString()}
                          </TableCell>
