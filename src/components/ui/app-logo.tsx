...
export function AppLogo({ className }: { className?: string }) {
  return (
    ...
    >
      <path d="M256 448C364.394 448 452 360.394 452 252C452 143.606 364.394 56 256 56C147.606 56 60 143.606 60 252C60 360.394 147.606 448 256 448Z" fill="#0F172A"/>
