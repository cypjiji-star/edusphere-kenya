...
>(({ className, asChild = false, onClick, ...props }, ref) => {
  ...
  if (isMobile) {
    return (
      ...
      >
        <div
          className="w-1 h-8 bg-cyan-500 rounded-full transition-all group-hover:h-12 group-active:h-10 group-active:bg-cyan-400"
